...
pinMode(PHONE_key,INPUT_PULLUP);//D9 КНОПКА ВКЛЮЧЕНИЯ НАУШНИКОВ HEADPHONES 
...
//МИГАЕМ ИНДИКАТОРОМ "MUTE" ПОЛУЧАЯ СИГНАЛ С ПДУ, ПОСЛЕ НАСТРОЙКИ МОЖНО ЗАКОМЕНТИРОВАТЬ
...
//////////////////////////////////// TREBLE -20 ... +20 dB //////////////////////////////////////
if(menu==0){
if(S.F4==true){ar=uint8_t(8);S.F1=true;sm0=0;
S.F4=false;}
...
if(menu==20){
if(mill>timer1+p1000){S.F7=!S.F7;
lcd.setCursor(8,0); 
switch(S.F7){
